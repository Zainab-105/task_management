    ...
    @case('file')
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9 col-xl-6">
                ...
                <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url({{ $setting->value ? generate_url($setting->value) : asset('frontend/images/logo.svg') }})">
                    <div class="image-input-wrapper" style="background-image:url({{ $setting->value ? generate_url($setting->value) : asset('frontend/images/logo.svg') }})"></div>
