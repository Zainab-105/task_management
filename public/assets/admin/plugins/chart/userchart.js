$(document).ready(function () {
    ...
    var vendorPieChartUrl = "active-deactive-vendors-chart";
    ...
    var vendorPieChart = new ApexCharts(
        document.querySelector("#vendor-active-pie-chart"),
        vendorPieOptions
    );
    userBarChart.render();
    userPieChart.render();
    vendorPieChart.render();
    ...
    var updateVendorPieChart = function () {
        $.ajax({
            url: vendorPieChartUrl,
            type: "GET",
            dataType: "json",
            headers: {
                "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
            ...
            data: {},
            success: function (data) {
                $("#active_vendor_count").text(data.data[0]);
                $("#deactive_vendor_count").text(data.data[1]);
                vendorPieChart.updateOptions({
                    labels: data.labels,
                    series: data.data,
                    colors: ["rgb(0, 183, 70)", "rgb(239, 64, 60)"],
                });
